...
<template>
    <div class="test">
                ...
                <Column :exportable="false" style="min-width:8rem">
                    <template #body="slotProps">
                        <Button icon="pi pi-pencil" outlined rounded class="mr-2"
                            @click="editAignatura(slotProps.data)" />
        ...
        <Dialog v-model:visible="deleteAsignaturaDialog" :style="{ width: '450px' }" header="Confirmación"
            :modal="true">
        ...
        <Dialog v-model:visible="deleteAsignaturasDialog" :style="{ width: '450px' }" header="Confirmación"
            :modal="true">
            <div class="confirmation-content">
                <i class="pi pi-exclamation-triangle mr-3" style="font-size: 2rem" />
